...
if __name__ == "__main__":
    ...
    plt.text(700,400,r'1 unit = 10 likes')
    ...
    plt.text(70, 0.08, r'1 unit = 10 likes')
    # plt.show()
    ...
    plt.text(140,6000000000,r'1 unit = 1 Min')
    # plt.show()
    ...
    plt.text(140,2500,r'1 unit = 1 Min')
    # plt.show()
    ...
    plt.text(140,80000000,r'1 unit = 1 Min')
    # plt.show()
